...
Plugin URI: http://teen-diary.com/wp-plugins/
Description: This plugin base on bp-group-livechat of  David Cartwright, thanks to him. chat room for groups use tinychat, with pro version ( goto http://teen-diary.com/wp-plugins/)user can login to chat room auto with wordpress username. If you are using Advanced AJAX Page Loader or Ajaxify Wordpress Site(AWS), please add "group-chat" to "HREF Ignore List" in setting box of that plugin.
Version: 1.0
...
License: AGPL
Author: Van dat
Author URI: http://teen-diary.com/wp-plugins/
Site Wide Only: true
*/
